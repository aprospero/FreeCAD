...
def equals(u, v, precision=0):
    ...
    v         : Base::Vector3
                The second vector.
    precision : int
                mathematical precision - if zero use configured draft
                precision
...
def isNull(vector, precision=0):
    ...
    is not set or set < 1 the configured Draft precision is used.
    ...
    vector : Base::Vector3
        The tested vector.
    precision : int
                mathematical precision - if < 1 use configured draft
                precision
...
def find(vector, vlist, precision=0):
...
def isColinear(vlist, precision=0):
...
def removeDoubles(vlist, precision=0):
...
def get_spherical_coords(x, y, z, precision=0):
